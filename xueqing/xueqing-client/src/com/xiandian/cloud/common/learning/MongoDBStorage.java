...
//	private Properties PROPERTIES = UtilTools.getConfig(System.getProperty("user.dir") + "/info/mongodb.properties");	
	...
	public MongoClient setUp() {
		try {
			...
			String mongodb_url = com.xiandian.cloud.common.util.UtilTools.getConfig().getProperty("mongodb_url");
			String mongodb_port = com.xiandian.cloud.common.util.UtilTools.getConfig().getProperty("mongodb_port");
			int port = Integer.parseInt(mongodb_port);
			// 连接到 mongodb 服务
			 mongoClient = new MongoClient(mongodb_url,port);
